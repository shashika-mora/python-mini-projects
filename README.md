...
Short and sweet Python Mini Projects for beginners. This repository contains a collection of simple scripts to practice core Python concepts.

## 📂 Projects

### 1. ✂️ Rock Paper Scissors (`rock_paper_scissor.py`)
...
### 4. �️ Password Manager (`password_manager.py`)
...
## 🚀 How to Run
Make sure you have Python installed. You may need to install dependencies for the Password Manager:
```bash
